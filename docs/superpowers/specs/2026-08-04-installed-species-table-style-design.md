...
The Installed species table will inherit the reference table's foreground semibold column headers, 40-pixel header height, eight-pixel cell padding, row dividers, and muted row-hover treatment. Its current minimum width and column content remain specific to Species control. Species names remain medium weight, scientific names remain italic and bark-colored, counts remain right-aligned tabular data, selection and Custom checkboxes remain centered, and Policy remains right-aligned.
